...
#   inside a cutoff radius. Then it plots the results in a Venn diagram                 #
#   (only for 2 or 3 different observables).                                            #
#                                                                                       #
...
def write_coordination(coordination,combination):
    ...
    # Double Coordination
    f.write('\n')
    f.write('Coordination with 2 type of molecule: \n')
    ...
    if len(coordination)>3:
        f.write('\n')
        f.write('\n')
        f.write('Coordination with 3 type of molecule: \n')
    ...
    if len(coordination)>4:
        f.write('\n')
        f.write('\n')
        f.write('Coordination with 4 type of molecule: \n')
    ...
    if len(coordination)>5:
        f.write('\n')
        f.write('\n')
        f.write('Coordination with 5 type of molecule: \n')
...
def plot_prob_map(coordination,observable):
    ...
    plt.figure()
    plt.imshow(prob_map,cmap='hot',vmin=0,vmax=limit,origin='lower')
    cbar=plt.colorbar()
