...
#   important information for the future analysis in a file with the same name and .txt format.   #
#                                                                                                 #
#   Structure of the output file:                                                                 #
#   #_atom   ID_atom   #_molecule   ID_molecule  X   Y   Z                                        #
#                                                                                                 #
#   The .txt output of this code serves as input for the rest of analysis codes.                  #
#                                                                                                 #
###################################################################################################
...
# change the name of the atoms if they are repeated.
...
print('\n')
print('Size of Initial .pdb: %.2f MB \n' %(size_input_file/(1024*1024)))
print('\n')
...
print('\n')
print('Size of Processed .txt: %.2f MB \n' %(size_output_file/(1024*1024)))
